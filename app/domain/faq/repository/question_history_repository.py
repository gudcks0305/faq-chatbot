...
class QuestionHistory:
    def __init__(self, user_id: str, vector: list[float], question: str,
        role: str = "user"):
...
class QuestionHistoryRepository:
    ...
    def add_history(self, user_id: str, vector: list[float], question: str,
        role: str = "user"):
        if user_id not in self.history:
            self.history[user_id] = []
        self.history[user_id].append(
            QuestionHistory(user_id, vector, question, role))
